...
const EditProduct = () => {
  ...
  const handleImageUpload = async (files, setFieldValue, currentImages) => {
    ...
    // Create a copy of current images that will be updated as we go
    ...
    for (let file of filesToUpload) {
      ...
      try {
        ...
        // Add to our local updated images array
        updatedImages.push({ url: data.imageUrl, altText: "" });

        // Update the form field with all uploaded images so far
